...
function svg(className: string, children: ReactNode) {
  return (
    <svg
...
export const sidebarIcons = {
  ...
  calendarDays: ({ className = "" }: IconProps) =>
    svg(className, (
      <>
        <path d="M8 2v4" />
        <path d="M16 2v4" />
  ...
  layoutGrid: ({ className = "" }: IconProps) =>
    svg(className, (
      <>
  ...
  calendarRange: ({ className = "" }: IconProps) =>
    svg(className, (
      <>
        <rect width="18" height="18" x="3" y="4" rx="2" />
        <path d="M16 2v4" />
  ...
  graduationCap: ({ className = "" }: IconProps) =>
    svg(className, (
      <>
