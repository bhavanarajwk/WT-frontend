...
export function TimelogPageClient() {
  ...
  const [timelogSubTab, setTimelogSubTab] = useState<"my" | "team">(
    pathname.includes("/dashboard/timelog/team") ? "team" : "my"
  );
  useEffect(() => {
    if (pathname.includes("/dashboard/timelog/team")) setTimelogSubTab("team");
    else if (pathname.includes("/dashboard/timelog")) setTimelogSubTab("my");
  }, [pathname]);
